...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet(u"background-color: #121212; color: white;")
...
"border-radius: 10px;       /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.gridLayout_2.addWidget(self.label_Captcha, 0, 0, 1, 1)
...
"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.gridLayout_2.addWidget(self.comboBox_CaptchaService, 0, 1, 1, 2)
...
"}")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_Threads, 1, 1, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.label_MinProxiScore, 2, 0, 1, 2)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_MinProxyScore, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_EmailFolder, 3, 0, 1, 2)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_EmailFolder, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.label_ImapDomain, 4, 0, 1, 2)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_ImapDomain, 4, 2, 1, 1)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_Min, 5, 2, 1, 1)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_Max, 5, 4, 1, 1)
...
"background-color: #424242 ;")
        ...
        self.gridLayout_2.addWidget(self.lineEdit_REFCODE, 6, 2, 1, 1)
        ...
        self.comboBox_NODE_TYPE = QComboBox(self.frame)
        self.comboBox_NODE_TYPE.addItem("")
        self.comboBox_NODE_TYPE.addItem("")
        self.comboBox_NODE_TYPE.addItem("")
        self.comboBox_NODE_TYPE.setObjectName(u"comboBox_NODE_TYPE")
        self.comboBox_NODE_TYPE.setStyleSheet(u"background-color: #303030 ;\n"
"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")

        self.gridLayout_2.addWidget(self.comboBox_NODE_TYPE, 7, 2, 1, 1)
...
"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.tab.setStyleSheet(u"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.scrollAreaWidgetContents_2.setGeometry(QRect(0, 0, 400, 276))
        ...
        self.tab_3.setStyleSheet(u"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.tab_2.setStyleSheet(u"border-radius: 5px; /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
...
"}")
        ...
        self.gridLayout_3.addWidget(self.pushButton_StartFarming, 1, 0, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.pushButton_Registration, 1, 1, 1, 1)
...
"}")
        ...
        self.gridLayout_3.addWidget(self.pushButton_Save, 1, 3, 1, 1)
...
"border-radius: 5px;       /* \u0417\u0430\u043a\u0440\u0443\u0433\u043b\u0435\u043d\u043d\u044b\u0435 \u0443\u0433\u043b\u044b */")
        ...
        self.gridLayout_3.addWidget(self.textEdit_Log, 2, 0, 1, 4)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1242, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(QCoreApplication.translate("MainWindow", u"NODE_TYPE", None))
        self.comboBox_NODE_TYPE.setItemText(0, QCoreApplication.translate("MainWindow", u"1x", None))
        self.comboBox_NODE_TYPE.setItemText(1, QCoreApplication.translate("MainWindow", u"1_25x", None))
        self.comboBox_NODE_TYPE.setItemText(2, QCoreApplication.translate("MainWindow", u"2x", None))
